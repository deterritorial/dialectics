...
class TextList(BaseObject, UserList):
    ...
    def matchgraph(self,draw=True,node_name='node',**kwargs):
        from intertxt.models.networks import draw_nx
    ...
    def match(self, *texts,rel=MATCHRELNAME,_progress=True,**kwargs):
        from intertxt.models.matching import match_by_title
    ...
    def into_lsh(self,progress=True,batch_n=10):
        from intertxt.models.matching import get_lsh,get_all_lsh_keys
        lsh = get_lsh()
    ...
    def match_by_hash(self,progress=True):
        from intertxt.models.matching import get_lsh
        lsh = get_lsh()
        iterr=self
